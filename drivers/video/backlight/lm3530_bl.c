...
#define DEFAULT_BRIGHTNESS 0x6F//0x6A//0x73
 
#define LM3530_MIN_BRIGHTNESS	0x57 // 10% full 22.5mA
#define LM3530_DEFAULT_BRIGHTNESS	0x6F//0x6A//0x73 // 75%  full 22.5mA

#define LM3530_MIN_VALUE_SETTINGS 30
#define LM3530_DEFAULT_VALUE_SETTINGS 102
...
static struct lm3530_ctrl_tbl lm3530_normal_tbl[] = {
	{ LM3530BL_REG_GENERAL_CONFIGURATION, 0x11 },   // Full Scale Current Select 26mA, exponential
...
/* The range of value from brightness bar settings is LM3530_MIN_VALUE_SETTINGS ~ 255 
   ...
   If you want to arrange the range of brightness bar in settings, you can set the value about LM3530_MIN_BRIGHTNESS.*/
	...
	printk("input brightness value=%d]\n", next);
