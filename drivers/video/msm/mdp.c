...
//LGE_FW_LCD_K_CAL //lcd_cal
		//mfd->lut_update = mdp_lut_update_nonlcdc;	//LGE_UPDATE heebae.song For applying GC LUT
		//mfd->do_histogram = mdp_do_histogram;     //LGE_UPDATE heebae.song For applying GC LUT
