...
//20111220 kyungyoul.lee@lge.com FRAMEWORK M3S - enable whole level LMK log
...
//20111221 kyungyoul.lee@lge.com FRAMEWORK M3S - add debug string
#if (0)
...
#else
#define lowmem_print(level, fmt, args...)			\
	do {						\
		if (lowmem_debug_level >= (level))	\
			printk("[%d] :" fmt, __LINE__,  ##args);	\
	} while (0)
#endif /* 0 */
