...
// Start tao.jin@lge.com  2012-01-28  Skip 7 of preview frame to avoid flashing after capturing porting from Batman
...
// jungki.kim@lge.com  2012-01-07  Skip 2 of preview frame to avoid flashing after capturing }
// End tao.jin@lge.com  2012-01-28  Skip 7 of preview frame to avoid flashing after capturing porting from Batman
static void vfe31_process_output_path_irq_0(uint32_t ping_pong)
{
	...
	*/
	// Start tao.jin@lge.com  2012-01-28  Skip 7 of preview frame to avoid flashing after capturing porting from Batman
	// jungki.kim@lge.com  2012-01-07  Skip 2 of preview frame to avoid flashing after capturing {
	if ( (VFE_MODE_OF_OPERATION_SNAPSHOT != vfe31_ctrl->operation_mode) && skip_preview_frame < 7) {
...
static void vfe31_process_snapshot_frame(uint32_t ping_pong)
{
	...
	CDBG("[CAMERA] %s: skip_preview_frame to be 0\n",__func__);
	// jungki.kim@lge.com  2012-01-07  Skip 2 of preview frame to avoid flashing after capturing }
	// End tao.jin@lge.com  2012-01-28  Skip 7 of preview frame to avoid flashing after capturing porting from Batman
