...
// LGE_UPDATE_S jeonghoon.cho@lge.com : modification QCTK 7/14
#if 1
	...
	if(gain_NR < 0xD20 && line < 800)	//under 5.2
	{
		...
		rc = mt9p017_i2c_write_w_sensor(0x3102, 0x01);	//25
...
/* LGE_UPDATE_S jeonghoon.cho@lge.com : modification QCTK 0701
...
// LGE_UPDATE_E jeonghoon.cho@lge.com : modification QCTK 0701
