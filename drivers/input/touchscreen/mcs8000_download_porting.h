...
#define GPIO_TOUCH_SCL 		70
#define GPIO_TOUCH_SDA 		71
#define GPIO_TOUCH_INT 		43
...
#if defined(CONFIG_MACH_MSM7X27A_M3EU) || defined(CONFIG_MACH_MSM7X27A_M3MPCS) || defined(CONFIG_MACH_MSM7X25A_M3DVIV) || defined(CONFIG_MACH_MSM7X25A_M3DOPEN) ||defined (CONFIG_MACH_LGE_M3S)
...
#define MCSDL_GPIO_SCL_SET_OUTPUT(n)				gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_SCL, 0, GPIO_CFG_OUTPUT,GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);//gpio_direction_output(GPIO_TOUCH_SCL, n)
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_SCL, 0, GPIO_CFG_INPUT,GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);//gpio_direction_input(GPIO_TOUCH_SCL)
#define MCSDL_GPIO_SCL_IS_HIGH()					((gpio_get_value(GPIO_TOUCH_SCL) > 0) ? 1 : 0)

#define MCSDL_GPIO_SDA_SET_OUTPUT(n)				gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_SDA, 0, GPIO_CFG_OUTPUT,GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);//gpio_direction_output(GPIO_TOUCH_SDA, n)

#define MCSDL_GPIO_SDA_SET_INPUT()					gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_SDA, 0, GPIO_CFG_INPUT,GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);//gpio_direction_input(GPIO_TOUCH_SDA)
