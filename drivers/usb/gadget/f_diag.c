...
static struct diag_context *the_diag;
#endif
/* 2011.12.07 jaeho.cho@lge.com diag enable/disable*/
...
{
	diag_function_disable(&the_diag->function);
}
EXPORT_SYMBOL(diag_disable);
extern int get_user_diag_enable(void);
#endif
/* 2011.12.07 jaeho.cho@lge.com diag enable/disable*/
