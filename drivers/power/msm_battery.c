...
// END: 0018132: hyunjong.do@lge.com 2011-03-17
 ...
 /* LGE_CHANGE_S [jinnie.kim@lge.com] 2010-11-01, check battery thermistor is valid or not */
	msm_batt_info.battery_temp 	= battery_temp;
//	msm_batt_info.battery_temp 	= 230;
/* LGE_CHANGE_S [jinnie.kim@lge.com] 2010-11-01, check battery thermistor is valid or not */
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
   	DBG_LIMIT("BATT: low battery  ext  = [%d] soc  = [%d]", ext_pwr,battery_soc);  // bart
